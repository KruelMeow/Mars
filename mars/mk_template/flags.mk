...
LOCAL_CFLAGS +=	-Wno-infinite-recursion -Wno-gnu-designator -Wno-unused-const-variable	-Wno-unused-local-typedef -Wno-unused-private-field -Wno-error=unused-variable -Werror=maybe-uninitialized
LOCAL_CFLAGS += -Wno-overloaded-virtual#ndk r13 compile


 LOCAL_CFLAGS += -DWEBRTC_ANDROID -DWEBRTC_CLOCK_TYPE_REALTIME -DWEBRTC_THREAD_RR -DWEBRTC_LINUX -DWEBRTC_ARCH_ARM -DWEBRTC_DETECT_ARM_NEON -DWEBRTC_POSIX
