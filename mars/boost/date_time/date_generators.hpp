...
namespace date_time {
 ...
 public:
   ...
   /*! Will throw an 'invalid_argument2' exception if a partial_date object,
    * instantiated with Feb-29, has get_date called with a non-leap year.
    * Example:
    * @code
    * partial_date pd(29, Feb);
    * pd.get_date(2003); // throws invalid_argument2 exception
   ...
   date_type get_date(year_type y) const
   {
     if((day_ == 29) && (month_ == 2) && !(calendar_type::is_leap_year(y))) {
       ...
       mars_boost::throw_exception(std::invalid_argument2(ss.str()));
     }
