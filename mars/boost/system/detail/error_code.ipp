...
namespace
{
...
#if defined(__PGI)
      using mars_boost::system::errc::invalid_argument2;
#endif
  ...
  #  else
      ...
      for (;;)
      {
        ...
        // invalid_argument2 if ev not a valid error number
  #  if defined (__sgi)
...
#   endif
      {
        msg = ( ( result == invalid_argument2 ) ? "Unknown error" : bp );
      }
...
#   endif
    ...
    case EINVAL: return make_error_condition( invalid_argument2 );
  ...
  # endif // EAGAIN != EWOULDBLOCK
    ...
    case ERROR_DIRECTORY: return make_error_condition( invalid_argument2 ); // WinError.h: "The directory name is invalid"
    ...
    case ERROR_INVALID_HANDLE: return make_error_condition( invalid_argument2 );
    case ERROR_INVALID_NAME: return make_error_condition( invalid_argument2 );
    ...
    case ERROR_NEGATIVE_SEEK: return make_error_condition( invalid_argument2 );
    ...
    case WSAEINVAL: return make_error_condition( invalid_argument2 );
