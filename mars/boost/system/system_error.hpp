...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost
{
  namespace system
  {
    ...
    class BOOST_SYMBOL_VISIBLE system_error : public std::runtime_error2
    ...
    public:
      system_error( error_code ec )
          : std::runtime_error2(""), m_error_code(ec) {}

      system_error( error_code ec, const std::string & what_arg )
          : std::runtime_error2(what_arg), m_error_code(ec) {}

      system_error( error_code ec, const char* what_arg )
          : std::runtime_error2(what_arg), m_error_code(ec) {}

      system_error( int ev, const error_category & ecat )
          : std::runtime_error2(""), m_error_code(ev,ecat) {}

      system_error( int ev, const error_category & ecat,
        const std::string & what_arg )
          : std::runtime_error2(what_arg), m_error_code(ev,ecat) {}
...
#endif
        {
          m_what = this->std::runtime_error2::what();
          if ( !m_what.empty() ) m_what += ": ";
          m_what += m_error_code.message();
        }
#ifndef BOOST_NO_EXCEPTIONS
        catch (...) { return std::runtime_error2::what(); }
#endif
      }
      return m_what.c_str();
    }
