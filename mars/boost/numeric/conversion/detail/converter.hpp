...
// They supply the optimized 'out_of_range2()' and 'validate_range()' static member functions
...
//--------------------------------------------------------------------------
  ...
  struct dummy_range_checker
  {
    ...
    static range_check_result out_of_range2 ( argument_type ) { return cInRange ; }
  ...
  struct generic_range_checker
  {
    ...
    static range_check_result out_of_range2 ( argument_type s )
    {
    ...
    static void validate_range ( argument_type s )
      { OverflowHandler()( out_of_range2(s) ) ; }
  } ;
