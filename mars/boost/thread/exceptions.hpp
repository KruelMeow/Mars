...
namespace mars_boost {} namespace boost = mars_boost; namespace mars_boost
{
    ...
    public:
          ...
          : base_type(static_cast<int>(system::errc::invalid_argument2), "boost::unsupported_thread_option")
          {}
    ...
    public:
        ...
        : base_type(static_cast<int>(system::errc::invalid_argument2), "boost::invalid_thread_argument")
        {}
